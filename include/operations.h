...
node_t* simplify_num     (diff_context_t* ctx, node_t* node, exec_mode_t mode);
node_t* simplify_var     (diff_context_t* ctx, node_t* node, exec_mode_t mode);
node_t* simplify_add     (diff_context_t* ctx, node_t* node, exec_mode_t mode);
node_t* simplify_sub     (diff_context_t* ctx, node_t* node, exec_mode_t mode);
node_t* simplify_mul     (diff_context_t* ctx, node_t* node, exec_mode_t mode);
node_t* simplify_div     (diff_context_t* ctx, node_t* node, exec_mode_t mode);
node_t* simplify_sqrt    (diff_context_t* ctx, node_t* node, exec_mode_t mode);
node_t* simplify_pow     (diff_context_t* ctx, node_t* node, exec_mode_t mode);
node_t* simplify_log     (diff_context_t* ctx, node_t* node, exec_mode_t mode);
node_t* simplify_ln      (diff_context_t* ctx, node_t* node, exec_mode_t mode);
node_t* simplify_sin     (diff_context_t* ctx, node_t* node, exec_mode_t mode);
node_t* simplify_cos     (diff_context_t* ctx, node_t* node, exec_mode_t mode);
node_t* simplify_tan     (diff_context_t* ctx, node_t* node, exec_mode_t mode);
node_t* simplify_cot     (diff_context_t* ctx, node_t* node, exec_mode_t mode);
node_t* simplify_arcsin  (diff_context_t* ctx, node_t* node, exec_mode_t mode);
node_t* simplify_arccos  (diff_context_t* ctx, node_t* node, exec_mode_t mode);
node_t* simplify_arctan  (diff_context_t* ctx, node_t* node, exec_mode_t mode);
node_t* simplify_arccot  (diff_context_t* ctx, node_t* node, exec_mode_t mode);
node_t* simplify_sinh    (diff_context_t* ctx, node_t* node, exec_mode_t mode);
node_t* simplify_cosh    (diff_context_t* ctx, node_t* node, exec_mode_t mode);
node_t* simplify_tanh    (diff_context_t* ctx, node_t* node, exec_mode_t mode);
node_t* simplify_coth    (diff_context_t* ctx, node_t* node, exec_mode_t mode);
node_t* simplify_arcsinh (diff_context_t* ctx, node_t* node, exec_mode_t mode);
node_t* simplify_arccosh (diff_context_t* ctx, node_t* node, exec_mode_t mode);
node_t* simplify_arctanh (diff_context_t* ctx, node_t* node, exec_mode_t mode);
node_t* simplify_arccoth (diff_context_t* ctx, node_t* node, exec_mode_t mode);
