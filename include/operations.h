...
node_t* simplify_num     (diff_context_t* ctx, node_t* node);
node_t* simplify_var     (diff_context_t* ctx, node_t* node);
node_t* simplify_add     (diff_context_t* ctx, node_t* node);
node_t* simplify_sub     (diff_context_t* ctx, node_t* node);
node_t* simplify_mul     (diff_context_t* ctx, node_t* node);
node_t* simplify_div     (diff_context_t* ctx, node_t* node);
node_t* simplify_sqrt    (diff_context_t* ctx, node_t* node);
node_t* simplify_pow     (diff_context_t* ctx, node_t* node);
node_t* simplify_log     (diff_context_t* ctx, node_t* node);
node_t* simplify_ln      (diff_context_t* ctx, node_t* node);
node_t* simplify_sin     (diff_context_t* ctx, node_t* node);
node_t* simplify_cos     (diff_context_t* ctx, node_t* node);
node_t* simplify_tan     (diff_context_t* ctx, node_t* node);
node_t* simplify_cot     (diff_context_t* ctx, node_t* node);
node_t* simplify_arcsin  (diff_context_t* ctx, node_t* node);
node_t* simplify_arccos  (diff_context_t* ctx, node_t* node);
node_t* simplify_arctan  (diff_context_t* ctx, node_t* node);
node_t* simplify_arccot  (diff_context_t* ctx, node_t* node);
node_t* simplify_sinh    (diff_context_t* ctx, node_t* node);
node_t* simplify_cosh    (diff_context_t* ctx, node_t* node);
node_t* simplify_tanh    (diff_context_t* ctx, node_t* node);
node_t* simplify_coth    (diff_context_t* ctx, node_t* node);
node_t* simplify_arcsinh (diff_context_t* ctx, node_t* node);
node_t* simplify_arccosh (diff_context_t* ctx, node_t* node);
node_t* simplify_arctanh (diff_context_t* ctx, node_t* node);
node_t* simplify_arccoth (diff_context_t* ctx, node_t* node);
...
const operation_t OperationsTable[nOperations] =
    {
    //   .code      .name     .is_binary     .calc_func       .diff_func        .tex_func    .simplify_func
        { ADD,       "+",         true,       &calc_add,       &diff_add,        &tex_add,      &simplify_add,    },
        { SUB,       "-",         true,       &calc_sub,       &diff_sub,        &tex_sub,      &simplify_sub,    },
        { MUL,       "*",         true,       &calc_mul,       &diff_mul,        &tex_mul,      &simplify_mul,    },
        { DIV,       "/",         true,       &calc_div,       &diff_div,        &tex_div,      &simplify_div,    },
        { SQRT,      "sqrt",      false,      &calc_sqrt,      &diff_sqrt,       &tex_sqrt,     &simplify_sqrt,   },
        { POW,       "^",         true,       &calc_pow,       &diff_pow,        &tex_pow,      &simplify_pow,    },
        { LOG,       "log",       true,       &calc_log,       &diff_log,        &tex_log,      &simplify_log,    },
        { LN,        "ln",        false,      &calc_ln,        &diff_ln,         &tex_ln,       &simplify_ln,     },
        { SIN,       "sin",       false,      &calc_sin,       &diff_sin,        &tex_sin,      &simplify_sin,    },
        { COS,       "cos",       false,      &calc_cos,       &diff_cos,        &tex_cos,      &simplify_cos,    },
        { TAN,       "tan",       false,      &calc_tan,       &diff_tan,        &tex_tan,      &simplify_tan,    },
        { COT,       "cot",       false,      &calc_cot,       &diff_cot,        &tex_cot,      &simplify_cot,    },
        { ARCSIN,    "arcsin",    false,      &calc_arcsin,    &diff_arcsin,     &tex_arcsin,   &simplify_arcsin, },
        { ARCCOS,    "arccos",    false,      &calc_arccos,    &diff_arccos,     &tex_arccos,   &simplify_arccos, },
        { ARCTAN,    "arctan",    false,      &calc_arctan,    &diff_arctan,     &tex_arctan,   &simplify_arctan, },
        { ARCCOT,    "arccot",    false,      &calc_arccot,    &diff_arccot,     &tex_arccot,   &simplify_arccot, },
        { SINH,      "sinh",      false,      &calc_sinh,      &diff_sinh,       &tex_sinh,     &simplify_sinh,   },
        { COSH,      "cosh",      false,      &calc_cosh,      &diff_cosh,       &tex_cosh,     &simplify_cosh,   },
        { TANH,      "tanh",      false,      &calc_tanh,      &diff_tanh,       &tex_tanh,     &simplify_tanh,   },
        { COTH,      "coth",      false,      &calc_coth,      &diff_coth,       &tex_coth,     &simplify_coth,   },
        { ARCSINH,   "arcsinh",   false,      &calc_arcsinh,   &diff_arcsinh,    &tex_arcsinh,  &simplify_arcsinh },
        { ARCCOSH,   "arccosh",   false,      &calc_arccosh,   &diff_arccosh,    &tex_arccosh,  &simplify_arccosh },
        { ARCTANH,   "arctanh",   false,      &calc_arctanh,   &diff_arctanh,    &tex_arctanh,  &simplify_arctanh },
        { ARCCOTH,   "arccoth",   false,      &calc_arccoth,   &diff_arccoth,    &tex_arccoth,  &simplify_arccoth },
    };
